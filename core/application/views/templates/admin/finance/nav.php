			...
			<ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
        			...
        			<ul class="dropdown-menu">
                    	<li><a href="<?php echo base_url()."index.php/admin/acctg/accounts" ?>">User List</a></li>
						<li><a href="<?php echo base_url()."index.php/admin/acctg/settings" ?>">Fee Settings</a></li>
                        <li><a href="<?php echo base_url()."index.php/admin/acctg/report" ?>">Reports</a></li>
					</ul>
      			</li>
            	<li>
