			...
			<ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
        			...
        			<ul class="dropdown-menu">
						<li><a href="<?php echo base_url()."index.php/admin/sys/dormitory" ?>">Dormitory</a></li>
                    	<li><a href="<?php echo base_url()."index.php/admin/sys/createadmin" ?>">Create Admin Account</a></li>
						<li><a href="<?php echo base_url()."index.php/admin/sys/adminlogs" ?>">Logs</a></li>
					</ul>
      			</li>
            	<li>
