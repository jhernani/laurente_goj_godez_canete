		...
		<div class="row">
			...
			<?php
				...
				{	
					...
					echo "</td>";
					echo "<td>";
						if($row->DUE_STATUS == '0' || $row->DUE_STATUS == '2')
						{
							echo "<form class='form' action=" . base_url(). "index.php/fee/pay_due" . " method='POST'>";
							echo "<div class='hide'>";
							echo "<input type='text' name='due_date' value=" . $row->DUE_DATE . ">";
							echo "<input type='text' name='u_id' value=" . $u_id . ">";
							echo "</div>";
							echo "<button class='btn btn-success btn-block' type='submit'>Paid</button>";
							echo "</form>";
						}
					echo "<td colspan='2'>";
						if($row->DUE_STATUS != '0')
